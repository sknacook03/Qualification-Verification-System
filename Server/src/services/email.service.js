    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p><a href="${process.env.FRONTEND_URL}/eduverify/">${process.env.FRONTEND_URL}/eduverify/</a></p>
            </div>
            <div class="footer">
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p><a href="${editLink}">${process.env.FRONTEND_URL}/eduverify/Editregister</a></p>
