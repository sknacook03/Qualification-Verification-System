        ...
        <div className={styles.noteContainer}>
          <div className={styles.noteBox}>
            ...
            <div className={styles.noteItem}>
              ...
              <span className={styles.noteText}>สอบถามข้อมูลเพิ่มเติมที่ สำนักส่งเสริมวิชาการและงานทะเบียน งานทะเบียนและประมวลผล โทรศัพท์: 0 4423 3000 ต่อ 2751 - 8 โทรศัพท์มือถือ: 08 3993 7945 ในวันและเวลาราชการ</span>
            </div>
          </div>
        </div>
