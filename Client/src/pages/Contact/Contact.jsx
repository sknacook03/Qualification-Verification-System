      ...
      <div className={styles.heroSection}>
        <div className={styles.glassCard}>
          <div className={styles.infoSection}>
            <h2>
              <span className={styles.brandAccent}>Contact</span> RMUTI<br />
              <span className={styles.subTitle}>มหาวิทยาลัยเทคโนโลยีราชมงคลอีสาน นครราชสีมา</span>
            </h2>
            <ul className={styles.infoList}>
              ...
              <li>
                <span className={styles.icon}>🌐</span>
                <a href="https://rmuti.ac.th" className={styles.link} target="_blank" rel="noopener noreferrer">
                  www.rmuti.ac.th
                </a>
              </li>
            </ul>
            <div className={styles.moreInfo}>
              <span className={styles.label}>ข้อมูลการเข้าศึกษาต่อ:</span> 2734<br />
          ...
          <div className={styles.mapSection}>
            <iframe
              ...
              width="100%" height="100%" style={{ border: 0, borderRadius: '20px', minHeight: '320px' }}
